...
train=pd.read_csv("cross_id_content/train_two_single_3_2.csv",usecols=usetruecols)
test=pd.read_csv("cross_id_content/test_two_single_3_2.csv",usecols=usetruecols)
...
all_train.to_csv("two_single_statis_feature_train_3_2.csv",index=None)
all_test.to_csv("two_single_statis_feature_test_3_2.csv",index=None)
t2=datetime.now()
print(t2-t1)
