...
train=pd.read_csv(input_path+"train_neg_pos_creativeSize.csv")
test=pd.read_csv(input_path+"test_neg_pos_creativeSize.csv")
all_vector=['creativeSize_neg','creativeSize_pos']
