...
all_train.to_csv(save_path+"three_multi_statis_feature_train_1_1_2.csv",index=None)
all_test.to_csv(save_path+"three_multi_statis_feature_test_1_1_2.csv",index=None)
