...
train=pd.read_csv("cross_id_content/train_three_multi_2_1.csv",usecols=useTruecols)
test=pd.read_csv("cross_id_content/test_three_multi_2_1.csv",usecols=useTruecols)
...
all_train.to_csv("three_multi_statis_feature_train_2_2.csv",index=None)
all_test.to_csv("three_multi_statis_feature_test_2_2.csv",index=None)
