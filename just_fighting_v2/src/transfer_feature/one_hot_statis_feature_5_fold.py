...
#15
usecols=['aid','age','gender','education','consumptionAbility','LBS','carrier','house','advertiserId','campaignId','adCategoryId','creativeSize','creativeId','productType','productId','label']
feat_List=usecols[:-1]
...
all_train.to_csv(save_path+"one_hot_statis_feature_train.csv",index=None)
all_test.to_csv(save_path+"one_hot_statis_feature_test.csv",index=None)
t2=datetime.now()
print(t2-t1)
