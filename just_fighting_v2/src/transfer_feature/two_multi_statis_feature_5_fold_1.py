...
train=pd.read_csv(input_path+"train_two_multi_1.csv")
test=pd.read_csv(input_path+"test_two_multi_1.csv")
...
all_train=None
all_test=None
for feat in tqdm(feat_List[0:13]):
...
all_train.to_csv(save_path+"two_multi_statis_feature_train_1.csv",index=None)
all_test.to_csv(save_path+"two_multi_statis_feature_test_1.csv",index=None)
