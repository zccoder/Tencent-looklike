...
data=data.fillna('-1')
del_vec=['appIdAction','appIdInstall','interest3','interest4','kw3','topic3','interest2','interest5','kw1','kw2','os','marriageStatus','topic1','topic2']
for i in del_vec:
	del data[i]
gc.collect()
#25个外加一个creativeSize
all_vector=['creativeSize','aid','advertiserId','campaignId','creativeId','adCategoryId','productId','productType','LBS','age',
