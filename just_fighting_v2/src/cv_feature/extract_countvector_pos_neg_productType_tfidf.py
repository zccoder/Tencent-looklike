...
train=pd.read_csv(input_path+"train_neg_pos_productType.csv")
test=pd.read_csv(input_path+"test_neg_pos_productType.csv")

all_vector=['productType_neg','productType_pos']
