...
# print(train.shape)
train=pd.read_csv("cross_id_content/train_creativeSize_kw2_topic2_stas.csv")
print(train.info(memory_usage='deep'))
test=pd.read_csv("cross_id_content/test_creativeSize_kw2_topic2_stas.csv")
...
all_train.to_csv("three_multi_statis_feature_train_1_1_1.csv",index=None)
all_test.to_csv("three_multi_statis_feature_test_1_1_1.csv",index=None)
