...
useTruecols=usecols[17:23]
useTruecols.append(usecols[-1])
feat_List=useTruecols[:-1]

train=pd.read_csv(input_path+"train_three_multi_2_2.csv",usecols=useTruecols)
test=pd.read_csv(input_path+"test_three_multi_2_2.csv",usecols=useTruecols)
...
all_train.to_csv(save_path+"three_multi_statis_feature_train_2_2.csv",index=None)
all_test.to_csv(save_path+"three_multi_statis_feature_test_2_2.csv",index=None)
