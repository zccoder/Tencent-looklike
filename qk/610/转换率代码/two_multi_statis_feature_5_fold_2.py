...
train=pd.read_csv("cross_id_content/train_two_multi_2.csv")
test=pd.read_csv("cross_id_content/test_two_multi_2.csv")
...
all_train.to_csv("two_multi_statis_feature_train_2.csv",index=None)
all_test.to_csv("two_multi_statis_feature_test_2.csv",index=None)
