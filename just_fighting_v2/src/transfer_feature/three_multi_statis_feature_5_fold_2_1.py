...
useTruecols=usecols[11:17]
useTruecols.append(usecols[-1])
feat_List=useTruecols[:-1]

train=pd.read_csv(input_path+"train_three_multi_2_1.csv",usecols=useTruecols)
test=pd.read_csv(input_path+"test_three_multi_2_1.csv",usecols=useTruecols)
...
all_train.to_csv(save_path+"three_multi_statis_feature_train_2_1.csv",index=None)
all_test.to_csv(save_path+"three_multi_statis_feature_test_2_1.csv",index=None)
