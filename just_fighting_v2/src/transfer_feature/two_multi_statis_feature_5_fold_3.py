...
usecols=['productType_kw2_stas', 'creativeSize_kw2_stas', 'creativeSize_topic1_stas', 'adCategoryId_kw2_stas', 'productType_topic2_stas', 'aid_interest2_stas', 'creativeSize_topic2_stas', 'creativeSize_kw1_stas', 'aid_topic2_stas', 'adCategoryId_topic2_stas', 'aid_kw2_stas', 'aid_kw1_stas', 'advertiserId_topic2_stas', 'advertiserId_kw2_stas', 'adCategoryId_kw1_stas', 'campaignId_topic2_stas', 'productType_topic1_stas', 'aid_marriageStatus_stas', 'productId_topic2_stas', 'aid_ct_stas', 'campaignId_kw1_stas', 'aid_topic1_stas', 'adCategoryId_topic1_stas', 'creativeSize_ct_stas', 'productType_kw1_stas', 'advertiserId_kw1_stas', 'productId_kw2_stas', 'advertiserId_topic1_stas', 'productId_topic1_stas', 'campaignId_kw2_stas', 'creativeSize_marriageStatus_stas', 'productId_kw1_stas', 'campaignId_topic1_stas', 'creativeSize_interest2_stas', 'advertiserId_ct_stas', 'productType_interest2_stas', 'adCategoryId_marriageStatus_stas','label']
usecols=[i.replace('stas','stats') for i in usecols]
feat_List=usecols[:-1]

train=pd.read_csv(input_path+"train_two_multi_3.csv")
test=pd.read_csv(input_path+"test_two_multi_3.csv")
...
all_train.to_csv(save_path+"two_multi_statis_feature_train_3.csv",index=None)
all_test.to_csv(save_path+"two_multi_statis_feature_test_3.csv",index=None)
