...
userFeature_data=[]
input_path='../../data/'
print("cs userFeature transform csv file start:")
with open(input_path+'userFeature_cs.data','r') as f:
	...
	user_feature.to_csv(input_path+"userFeature_cs.csv",index=False)
print("cs userFeature transform file end")
